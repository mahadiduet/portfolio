            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="relative">
                  <div className="absolute -left-6 top-2 w-4 h-4 bg-blue-600 rounded-full"></div>
                  <div className="border-l-2 border-blue-600 pl-6 ml-4">
                    <h4 className="text-xl font-medium text-gray-800">Bachelor's in Computer Science</h4>
                ...
                <div className="relative">
                  <div className="absolute -left-6 top-2 w-4 h-4 bg-blue-600 rounded-full"></div>
                  <div className="border-l-2 border-blue-600 pl-6 ml-4">
                    <h4 className="text-xl font-medium text-gray-800">Diploma-in-Engineering</h4>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="relative">
                  <div className="absolute -left-6 top-2 w-4 h-4 bg-blue-600 rounded-full"></div>
                  <div className="border-l-2 border-blue-600 pl-6 ml-4">
                    <h4 className="text-xl font-medium text-gray-800">Web Developer</h4>
                ...
                <div className="relative">
                  <div className="absolute -left-6 top-2 w-4 h-4 bg-blue-600 rounded-full"></div>
                  <div className="border-l-2 border-blue-600 pl-6 ml-4">
                    <h4 className="text-xl font-medium text-gray-800">Junior Web Developer</h4>
