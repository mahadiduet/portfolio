...
const Banner = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-between bg-[#FFF8F3] p-8 space-y-8 sm:space-y-0">
      <div className="banner-content flex-1 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row justify-start sm:justify-start gap-4 mt-4">
